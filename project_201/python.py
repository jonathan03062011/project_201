...
app_label=Label(window, text="SIMPLE INTEREST CALCULATOR", fg = "black", bg = "grey", font=("Calibris", 20),bd=5)
app_label.place(x=20, y=20)

principle_label=Label(window, text="Principle in Rs", fg = "black", bg = "grey", font=("Calibris", 12),bd=1)
principle_label.place(x=20, y=92)

principle=Entry(window, text="", bd=2, width=22)
principle.place(x=200, y=92)

rate_label=Label(window, text="Rate of Interest in %", fg = "black", bg = "grey", font=("Calibris", 12))
rate_label.place(x=20, y=140)

rate=Entry(window, text="", bd=2, width=15)
rate.place(x=200, y=142)

time_label=Label(window, text="Time in Yrs", fg = "black", bg = "grey", font=("Calibris", 12))
...
result_frame = LabelFrame(window,text="Result", bg = "grey", font=("Calibris", 12))
result_frame.pack(padx=20, pady=20)
result_frame.place(x=20,y=300)

result=Label(result_frame,text="Your result will be displayed here", bg = "grey", font=("Calibris", 12), width=55)
